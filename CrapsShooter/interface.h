...
public:
    ...
    void printAbove(Player& player1)
    {
        ...
        cout<<"  Roll the dice = 0          The Point is currently "<<player1.getPoint()<<endl;
        cout<<"      Pass Line = 1 "<<endl;
        cout<<"     Place Bets = 2 "<<endl;
        //cout<<"       Come Bet = 3 "<<endl;
        cout<<"      Field Bet = 4 "<<endl;
        //cout<<"Don't Pass Line = 5 "<<endl;
        //cout<<" Don't Come Bar = 6 "<<endl;
        //cout<<"  Center Action = 7 "<<endl;
        //cout<<"       Cash out = 8 "<<endl<<endl<<endl<<endl;
    }

    void printBelow(Player& player1)
    {
        cout<<"Current money: "<<player1.getMoney()<<endl<<endl;
